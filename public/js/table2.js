 ...
 */
 var $table = $('#fresh-table'),
      ...
      //      return [
       //
       //
      //          '<a href="acedit/1" rel="tooltip" title="Edit" class="table-action edit" href="javascript:void(0)" title="Edit">',
      //              '<i class="fa fa-edit">แก้ไข</i>',
      //          '</a>',
      //          '<a rel="tooltip" title="Remove" class="table-action remove" href="javascript:void(0)" title="Remove">',
      //              '<i class="fa fa-remove">ลบ</i>',
      //          '</a>'
      //      ].join('');
      //  }
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                sprintf('<i class="%s %s">เลือกแสดงผล</i>', this.options.iconsPrefix, this.options.icons.columns),
